...
_GROUPS: List[tuple] = [
    (2,  ["fire", "smoke", "flame", "wildfire", "ember", "hotspot", "burning", "blaze",
           "ignition", "char", "ash fall", "pyroclastic", "lava", "tephra"]),
    (3,  ["person", "human", "survivor", "victim", "pedestrian", "casualty", "injured", "missing",
           "stranded", "body", "civilian", "child", "hiker", "swimmer", "diver", "trapped"]),
    (4,  ["flood", "inundation", "surge", "submerged", "drowning", "overflow",
           "tsunami", "storm surge", "rising water", "flash flood", "levee breach",
           "coastal flood", "lahar", "mudflow"]),
    (5,  ["collapse", "structure", "building", "rubble", "debris", "damage", "destroyed",
           "ruin", "wreckage", "crack", "sinkhole", "landslide", "mudslide",
           "earthquake", "seismic", "tremor", "aftershock", "liquefaction",
           "avalanche", "mine collapse", "crater", "eruption"]),
    (6,  ["vehicle", "truck", "car", "boat", "vessel", "aircraft", "uav", "drone",
           "ship", "helicopter", "plane", "motorcycle", "atv", "submarine",
           "kayak", "raft", "life raft"]),
    (7,  ["hazmat", "chemical", "spill", "leak", "toxic", "gas", "explosion",
           "radiation", "biological", "contamination", "plume", "cloud", "vapor",
           "nuclear", "radiological", "nerve agent", "ammonia", "chlorine",
           "volcanic ash", "ash cloud", "air quality", "pollution", "pm25",
           "smog", "emission", "industrial smog"]),
    (8,  ["animal", "wildlife", "livestock", "poaching", "bear", "deer", "wolf",
           "cattle", "herd", "elephant", "shark", "crocodile", "alligator",
           "tiger", "jaguar", "leopard", "mountain lion", "orca", "whale",
           "dolphin", "rhino", "gorilla", "python", "moose", "bison",
           "eagle", "raptor", "feral"]),
    (9,  ["power line", "pipeline", "bridge", "road", "tower", "antenna", "dam",
           "levee", "rail", "utility", "cable", "pylon", "transformer",
           "substation", "refinery", "reactor", "port infrastructure"]),
    (10, ["crop", "field", "irrigation", "pest", "harvest", "farm", "orchard",
           "vineyard", "soil", "erosion", "drought", "blight", "infestation",
           "locust", "famine", "food shortage", "food insecurity"]),
    (11, ["medical", "injury", "unconscious", "cardiac", "trauma",
           "triage", "wounded", "mass casualty", "overdose", "seizure",
           "epidemic", "disease outbreak", "outbreak", "cholera",
           "contaminated water", "vaccination", "field hospital",
           "heat stroke", "hypothermia", "heat wave", "cold wave"]),
    (12, ["intrusion", "unauthorized", "trespass", "suspicious", "threat", "breach",
           "perimeter violation", "armed", "hostile", "illegal", "poacher",
           "civil unrest", "protest", "maritime intrusion", "port breach"]),
    (13, ["missing", "lost", "stranded", "downed", "overdue", "distress", "sos",
           "mayday", "signal", "beacon", "epirb", "plb", "search grid", "sar sector",
           "man overboard", "diver missing"]),
    (14, ["delivery", "supply drop", "drop zone", "aid drop", "cargo", "payload",
           "transport", "courier", "resupply", "package", "logistics", "deliver",
           "humanitarian", "relief delivery", "medicine shortage", "vaccine delivery",
           "food aid", "aid required"]),
]
