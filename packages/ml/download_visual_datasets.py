...
def download_coco_subset() -> Dict[str, int]:
    ...
    if os.path.exists(images_zip):
        ...
        print("Downloading COCO 2017 val images (~778 MB)…")
        print(
...
def build_combined_dataset(val_fraction: float = 0.20, seed: int = 42) -> None:
    ...
    yaml_lines = [
        ...
        "# Auto-generated by download_visual_datasets.py",
        "",
        f"path: {SUMMIT_DIR}",
        "train: images/train",
        "val: images/val",
...
def _print_manual_instructions(dataset: str, steps: List[str], dest: str) -> None:
    ...
    print("  Follow these steps to add it manually:")
...
def main() -> None:
    ...
    print("Heli.OS Visual Dataset Downloader")
