...
ASSET = ObjectTypeDef(
    ...
    properties=[
        PropertyDef(
            ...
            PropertyKind.STRING,
            required=True,
            description="Stable unique asset identifier",
            index=True,
        ),
        PropertyDef(
            "name",
        ...
        PropertyDef(
            "heading_deg", PropertyKind.FLOAT, description="True heading (degrees)"
        ),
        ...
        PropertyDef(
            "signal_db", PropertyKind.FLOAT, description="Uplink signal strength (dBm)"
        ),
        PropertyDef(
            "operator_id",
            PropertyKind.STRING,
        ...
        PropertyDef(
            "org_id", PropertyKind.STRING, description="Owning organisation", index=True
        ),
        PropertyDef(
            "capabilities",
            PropertyKind.ARRAY,
            item_kind=PropertyKind.STRING,
        ...
        PropertyDef(
            "serial", PropertyKind.STRING, description="Hardware serial number"
        ),
        PropertyDef(
            "metadata", PropertyKind.OBJECT, description="Free-form adapter metadata"
        ),
    ],
)
...
OPERATOR = ObjectTypeDef(
    ...
    properties=[
        ...
        PropertyDef(
            "assigned_missions", PropertyKind.ARRAY, item_kind=PropertyKind.STRING
        ),
    ],
)
...
SITREP = ObjectTypeDef(
    ...
    properties=[
        ...
        PropertyDef(
            "generated_by", PropertyKind.ENUM, enum_values=["kofa-template", "kofa-llm"]
        ),
...
TRACK = ObjectTypeDef(
    ...
    properties=[
        ...
        PropertyDef(
            "contributing_sensors", PropertyKind.ARRAY, item_kind=PropertyKind.STRING
        ),
        PropertyDef("org_id", PropertyKind.STRING, index=True),
        PropertyDef("metadata", PropertyKind.OBJECT),
    ],
