...
ALERT_ACKNOWLEDGED_BY_OPERATOR = LinkTypeDef(
    ...
    cardinality  = Cardinality.MANY_TO_ONE,
    properties   = [
        PropertyDef("notes",        PropertyKind.STRING,   description="Operator notes at acknowledgement"),
...
TRACK_CORRELATED_WITH_TRACK = LinkTypeDef(
    ...
    cardinality  = Cardinality.MANY_TO_MANY,
    properties   = [
        PropertyDef("correlation_score", PropertyKind.FLOAT, description="0–1 probability same entity"),
    ],
)
