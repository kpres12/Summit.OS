...
class IntegrationClient:
    ...
    def __init__(self, name: str = "External Integration",
    ...
    async def start(self) -> None:
        ...
        logger.info(f"Integration '{self.config.name}' started (id={self.config.integration_id})")
    ...
    def push_track(self, lat: float, lon: float, alt: float = 0.0,
                   heading: float = 0.0, speed: float = 0.0,
                   callsign: str = "", source_id: str = "",
        ...
        try:
            ...
            try:
                ...
                async with aiohttp.ClientSession() as session:
                    async with session.post(url, json={"entities": batch},
