...
A commercial license removes that requirement.
...
- Access to BigMT.ai managed hosting
...
| Use case | Price |
|---|---|
| Single commercial deployment (one org, one product) | Contact us |
| OEM / embedded (hardware product) | Contact us |
| Enterprise (multi-tenant, managed hosting, SLA) | Contact us |

We are founder-friendly and will work with early-stage companies on pricing.
If you are an NGO, fire department, or public safety agency, reach out —
we have a separate program for mission-critical civilian use.
...
- Approximate number of deployments / users
