...
You understand and agree that the Project maintainers may offer the Project, including Your Contributions, under additional license terms (including commercial licenses) alongside the AGPL v3 open source license. This enables the Project to sustain itself through enterprise licensing while keeping the community edition free.

## How to Sign

This CLA is signed electronically via the [CLA Assistant](https://cla-assistant.io/) GitHub App. When you open your first pull request, the CLA Assistant bot will ask you to sign by authenticating with your GitHub account. You only need to sign once.
